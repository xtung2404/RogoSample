...
class LocationTypeAdapter(context: Context, descList: List<IoTLocationType>): ArrayAdapter<IoTLocationType>(context, 0, descList) {
    ...
    private fun getCustomView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        getItem(position)?.let {
            textViewName.text = parent.context.getString(LocationType.getLocationDesc(it))
        }
