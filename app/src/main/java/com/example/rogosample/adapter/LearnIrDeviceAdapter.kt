...
class LearnIrDeviceAdapter (context: Context, deviceList: List<DeviceLearnIr>)
    : ArrayAdapter<DeviceLearnIr>(context, 0, deviceList){
    ...
    private fun getCustomView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        getItem(position)?.let {
            textViewName.text = context.getString(it.deviceName)
        }
